...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2019 at 12:34 PM
...
--
ALTER TABLE `loan`
  MODIFY `LoanID` int(12) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
GRANT USAGE ON *.* TO 'LibraryUser'@'%' IDENTIFIED BY PASSWORD '*A56EC454689C8A160633307A6ECC536111F5087A';

GRANT SELECT ON `libraryapp`.* TO 'LibraryUser'@'%';


# Privileges for `GWash`@`%`
