...
//    $myLoan = new Loan(98765, '2013-01-19', 1, 2); //Creating new loan object
...
//    $myLoanController->returnBook(98765, "2013-12-13", $myBook); //Testing return book function - changs mybook loan date to new return date
